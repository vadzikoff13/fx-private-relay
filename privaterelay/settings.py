...
_RELAY_MAYBE_DEV = (
    RELAY_CHANNEL == "prod" and SITE_ORIGIN != "https://relay.firefox.com"
)
...
TWILIO_BRAND_REGISTRATION_SID = config("TWILIO_BRAND_REGISTRATION_SID", None)
_DEFAULT_TWILIO_DEPLOYMENT = RELAY_CHANNEL
if _RELAY_MAYBE_DEV:
    _DEFAULT_TWILIO_DEPLOYMENT = "local"
TWILIO_DEPLOYMENT = config("TWILIO_DEPLOYMENT", _DEFAULT_TWILIO_DEPLOYMENT)
TWILIO_MAIN_NUMBER_DEPLOYMENT = config(
    "TWILIO_DEPLOYMENT", f"{_DEFAULT_TWILIO_DEPLOYMENT}-main"
)
