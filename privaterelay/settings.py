...
_DEFAULT_TWILIO_CHANNEL = RELAY_CHANNEL
if _RELAY_MAYBE_DEV:
    _DEFAULT_TWILIO_CHANNEL = "local"
TWILIO_CHANNEL = config("TWILIO_CHANNEL", _DEFAULT_TWILIO_CHANNEL)
TWILIO_MAIN_NUMBER_CHANNEL = config(
    "TWILIO_MAIN_NUMBER_CHANNEL", f"{_DEFAULT_TWILIO_CHANNEL}-main"
)
